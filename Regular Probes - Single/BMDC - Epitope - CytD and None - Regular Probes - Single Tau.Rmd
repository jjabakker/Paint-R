...
---
title: "BMDC - Epitope - CytD and None"
subtitle: 'Regular Probes - Single Procesing - 30 - 10'
fontfamily: sans
output:
  pdf_document:
    toc: yes
...
data_file <- data_file_regular_30_05
...
# Add the structure information to images_master
...
```{r echo=FALSE, tau_significance_bmdc_adj, fig.fullwidth=TRUE, fig.height=10, fig.width=16, warning=FALSE}
...
```{r echo=FALSE, fig.fullwidth=TRUE, fig.height=10, fig.width=16, warning=FALSE}
...
```{r echo=FALSE, combine_2, fig.fullwidth=TRUE, fig.height=10, fig.width=16, warning=FALSE}
grid.arrange(p1,
             p2, 
             ncol = 2)
...
# Density of Epitope probes on BMDC (wih mix of Threshold and concentrations) - Traditional

## Without significance

```{r echo=FALSE, fig.fullwidth=TRUE, fig.height=12, fig.width=12, warning=FALSE}
...
# Density of Epitope probes on BMDC (wih mix of Threshold and concentrations) - Single
